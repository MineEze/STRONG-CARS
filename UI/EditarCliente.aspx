<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="EditarCliente.aspx.cs" Inherits="UI.EditarCliente" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container containerAgregar">
        <asp:Label ID="LabelTitulo" runat="server" CssClass="titulo-pagina" Text="Modificar cliente"></asp:Label>
        <br />
        <asp:Label ID="LabelModificarClienteExito" runat="server" CssClass="alert alert-success alerta-personalizada" Text="Cliente modificado con éxito"></asp:Label>
        <br />
        ...
        <div class="form-group">
            <asp:Button ID="ButtonModificarCliente" runat="server" OnClientClick="return validarFormRegistrarCliente();" OnClick="ButtonModificarCliente_Click" class="btn btn-primary" Text="Editar" />
        </div>
    </div>
</asp:Content>
