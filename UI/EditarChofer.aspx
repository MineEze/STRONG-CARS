<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="EditarChofer.aspx.cs" Inherits="UI.EditarChofer" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container containerAgregar">
        <asp:Label ID="LabelTitulo" runat="server" CssClass="titulo-pagina" Text="Modificar chófer"></asp:Label>
        <br />
        <asp:Label ID="LabelModificarChoferExito" runat="server" CssClass="alert alert-success alerta-personalizada" Text="Chófer modificado con éxito"></asp:Label>
        <br />
        ...
        <div class="form-group">
            <asp:Button ID="ButtonModificarChofer" runat="server" OnClientClick="return validarFormRegistrarChofer();" OnClick="ButtonModificarChofer_Click" class="btn btn-primary" Text="Editar" />
        </div>
    </div>
</asp:Content>
